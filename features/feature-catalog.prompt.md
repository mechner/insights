...
* @feature-catalog.knowledge.md: background information and resources for generating and evaluating features in the catalog.
...
* Prioritize content that has been explicitly reviewed and confirmed by human expert as target state, identified in @feature-catalog.knowledge.md, or in features that have been "signed off" by a human expert.
...
2. If it doesn't already exist, create **feature-catalog.index.md** - an index of features; each will be a feature in the feature catalog. 
