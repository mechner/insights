...
2. @output/inferences.md; treat this as your "working hypothesis" - this is content you, the AI agent, have authored to efficiently summarize key information, but it hasn't been confirmed by a human expert.
...
2. Review @output/inferences.md to recall the working hypothesis where reference documents are incomplete or conflicting.
...
Actively explore the primary sources listed in resources.md. Do not rely solely on @output/inferences.md — treat it as a starting point that may be incomplete.
...
8. **Figma**: For each Figma file listed in resources.md, use the Figma MCP tool to screenshot and review any pages that @output/inferences.md has not yet covered, or where you are uncertain about scope or content. Update @output/inferences.md with any new findings.
...
### Step 3 — Update
10. Ask any clarifying questions needed to resolve uncertainties or conflicts. Document new inferences, assumptions, or reconciliations in @output/inferences.md.
